...
function createScroller(config) {
  ...
  return attachScrollEvent(options).pipe((0, import_operators6.mergeMap)(() => (0, import_rxjs8.of)(calculatePoints(element, resolver))), (0, import_operators6.map)((positionStats) => toInfiniteScrollParams(scrollState.lastScrollPosition, positionStats, distance)), (0, import_operators6.tap)(({
    stats
  }) => scrollState.updateScroll(stats.scrolled, stats.totalToScroll)), (0, import_operators6.filter)(({
    fire,
    scrollDown,
    stats: {
      totalToScroll
    }
  }) => shouldTriggerEvents(config.alwaysCallback, fire, scrollState.isTriggeredScroll(totalToScroll, scrollDown))), (0, import_operators6.tap)(({
    scrollDown,
    stats: {
      totalToScroll
    }
  ...
  }), (0, import_operators6.map)(toInfiniteScrollAction));
}
function attachScrollEvent(options) {
  let obs = (0, import_rxjs8.fromEvent)(options.container, "scroll");
  if (options.throttle) {
    obs = obs.pipe((0, import_operators6.throttleTime)(options.throttle, void 0, {
      leading: true,
      trailing: true
    }));
  }
...
var Select2 = class _Select2 {
  ...
  constructor(_viewportRuler, _changeDetectorRef, _parentForm, _parentFormGroup, _control, tabIndex) {
    ...
    this._stateChanges = new import_rxjs9.Subject();
