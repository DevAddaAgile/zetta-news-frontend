...
var SwiperComponent = class {
  constructor(_ngZone, elementRef, _changeDetectorRef, _platformId) {
    ...
    this._activeSlides = new import_rxjs.Subject();
    ...
    this.slidesChanges = (val) => {
      ...
      if (!this.virtual) {
        if (this.loopedSlides) {
          this.prependSlides = (0, import_rxjs.of)(this.slides.slice(this.slides.length - this.loopedSlides));
          this.appendSlides = (0, import_rxjs.of)(this.slides.slice(0, this.loopedSlides));
        }
  ...
  get activeSlides() {
    ...
    return (0, import_rxjs.of)(this.slides);
  }
